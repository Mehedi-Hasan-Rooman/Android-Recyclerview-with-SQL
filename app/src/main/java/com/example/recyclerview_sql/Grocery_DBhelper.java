...
import com.example.recyclerview_sql.Grocery_Contract.*;

import androidx.annotation.Nullable;

public class Grocery_DBhelper extends SQLiteOpenHelper {

    public static final String DATABASE_NAME = "grocerylist.db";
    public static final int DATABASE_VERSION = 1;

    public Grocery_DBhelper(@Nullable Context context) {
